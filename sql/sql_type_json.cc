...
/*
  This method ressembles what Type_handler::string_type_handler()
...
/*
  This method ressembles what Item_sum_group_concat::type_handler()
  does for general purpose string type handlers.
*/
const Type_handler *
...
class Type_collection_json: public Type_collection
{
  ...
  const Type_handler *aggregate_local(const Type_handler *a,
                                      const Type_handler *b) const
  {
    typedef Type_aggregator::PairL PairL;
    static const Type_aggregator::Pair agg[]=
    {
      PairL(&type_handler_long_blob_json,   &type_handler_varchar_json),
      PairL(&type_handler_long_blob_json,   &type_handler_tiny_blob_json),
      PairL(&type_handler_long_blob_json,   &type_handler_blob_json),
      PairL(&type_handler_long_blob_json,   &type_handler_medium_blob_json),
      PairL(&type_handler_long_blob_json,   &type_handler_string_json),

      PairL(&type_handler_medium_blob_json, &type_handler_varchar_json),
      PairL(&type_handler_medium_blob_json, &type_handler_tiny_blob_json),
      PairL(&type_handler_medium_blob_json, &type_handler_blob_json),
      PairL(&type_handler_medium_blob_json, &type_handler_string_json),

      PairL(&type_handler_blob_json,        &type_handler_varchar_json),
      PairL(&type_handler_blob_json,        &type_handler_tiny_blob_json),
      PairL(&type_handler_blob_json,        &type_handler_string_json),

      PairL(&type_handler_tiny_blob_json,   &type_handler_varchar_json),
      PairL(&type_handler_tiny_blob_json,   &type_handler_string_json),

      PairL(&type_handler_varchar_json,     &type_handler_string_json),
...
public:
                                           ...
                                           const override
  {
    ...
    if ((h= aggregate_common(a, b)) ||
        (h= aggregate_local(a, b)))
      return h;
    /*
      A combination of two JSON data types was not found.
